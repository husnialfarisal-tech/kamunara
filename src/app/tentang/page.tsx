...
// --- DATA TIM ---
const teamMembers = [
  { role: 'Manajer', name: 'Nama Manajer', image: '/images/manajer.JFIF', desc: 'Leading the Vision & Strategy. Bertanggung jawab atas arah keseluruhan perusahaan.' },
  { role: 'Supervisor', name: 'Nama Supervisor', image: '/images/manajer.JFIF', desc: 'Operational Excellence. Memastikan setiap proyek berjalan sesuai timeline dan kualitas.' },
  { role: 'Finance', name: 'Nama Finance', image: '/images/manajer.JFIF', desc: 'Financial Health. Mengelola kesehatan finansial dan perencanaan anggaran strategis.' },
  { role: 'Digital Program', name: 'Nama Programmer', image: '/images/manajer.JFIF', desc: 'Tech Innovation. Arsitek di balik solusi digital dan pengembangan sistem.' },
  { role: 'Sales Marketing 1', name: 'Nama Sales 1', image: '/images/manajer.JFIF', desc: 'Market Expansion. Membuka peluang pasar baru dan menjalin kemitraan strategis.' },
  { role: 'Sales Marketing 2', name: 'Nama Sales 2', image: '/images/manajer.JFIF', desc: 'Client Relations. Menjaga hubungan erat dan kepuasan klien jangka panjang.' },
  { role: 'Sales Marketing 3', name: 'Nama Sales 3', image: '/images/manajer.JFIF', desc: 'Growth Specialist. Fokus pada strategi pertumbuhan penjualan dan akuisisi.' },
]
