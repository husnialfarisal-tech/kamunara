...
import { Code2, Target, Heart, Users, Award, Zap, ArrowRight, Mail, MessageCircle, Facebook } from 'lucide-react' // <-- TAMBAH ikon sosial: Mail, MessageCircle (WA), Facebook
import Link from 'next/link'

// Import komponen reusable
import Navbar from '@/components/Navbar'
import Footer from '@/components/Footer'
import CTA from '@/components/CTA'  // Pakai CTA yang sudah ada
  ...
  return (
    <>
      ...
      <main className="pt-32 min-h-screen bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900">
        ...
        {/* About Kamunara Section – grid 2 kolom */}
          ...
          <div className="container mx-auto">
            ...
            >
              <div className="space-y-6">
                ...
                {/* TAMBAH MEDIA SOSIAL DI SINI */}
                {/* Bagian ini baru ditambahkan: Media Sosial di bawah stats */}
                <div className="mt-10">
                  ...
                  <div className="flex flex-wrap gap-4 justify-center">
                    ...
                    >
                      {/* Icon Instagram (pakai SVG kalau lucide tidak ada) */}
